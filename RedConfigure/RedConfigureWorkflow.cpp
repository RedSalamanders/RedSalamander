                                                                       ...
                                                                       std::wstring_view selectedCulture)
{
    ...
    const auto selectedColumn = std::find_if(
        orderedCultures.begin(), orderedCultures.end(), [selectedCulture](const std::wstring& culture) { return EqualIgnoreCase(culture, selectedCulture); });
