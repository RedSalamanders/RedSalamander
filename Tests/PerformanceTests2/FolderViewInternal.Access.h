...
public:
    ...
    FolderViewRenamePromptWindow(HWND ownerWindow, std::wstring initialText, [[maybe_unused]] bool isDirectory, const AppTheme& theme) noexcept
    ...
    [[nodiscard]] std::optional<std::wstring> ShowModal() noexcept
    {
        ...
        const HWND hwnd = CreateWindowExW(exStyle,
                                          ...
                                          LoadStringResource(nullptr, IDS_FOLDERVIEW_RENAME_CAPTION).c_str(),
                                          style,
                                          CW_USEDEFAULT,
                                          CW_USEDEFAULT,
