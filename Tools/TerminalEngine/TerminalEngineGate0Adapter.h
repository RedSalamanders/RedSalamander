...
typedef bool(RS_TERMINAL_GATE0_CALL*
...
typedef void(RS_TERMINAL_GATE0_CALL*
...
typedef RsTerminalGate0Result(
    RS_TERMINAL_GATE0_CALL* RsTerminalGate0SessionCreateFn)(
    const RsTerminalGate0SessionConfigV1* config,
    RsTerminalGate0Session* out_session);

typedef RsTerminalGate0Result(
    RS_TERMINAL_GATE0_CALL* RsTerminalGate0SessionWriteFn)(
    RsTerminalGate0Session session,
    const uint8_t* data,
    size_t length);

typedef RsTerminalGate0Result(
    RS_TERMINAL_GATE0_CALL* RsTerminalGate0SessionActionFn)(
    RsTerminalGate0Session session,
    const RsTerminalGate0ActionV1* action,
    RsTerminalGate0ActionObservationV1* out_observation);

typedef RsTerminalGate0Result(
    RS_TERMINAL_GATE0_CALL* RsTerminalGate0SessionStateJcsFn)(
    RsTerminalGate0Session session,
    uint8_t* buffer,
    size_t capacity,
    size_t* out_required);
...
typedef RsTerminalGate0Result(
    RS_TERMINAL_GATE0_CALL* RsTerminalGate0SessionDestroyFn)(
    RsTerminalGate0Session session);
...
typedef RsTerminalGate0Result(
    RS_TERMINAL_GATE0_CALL* RsTerminalGate0QueryAdapterFn)(
    uint32_t query_symbol_version,
    uint32_t requested_adapter_abi,
    RsTerminalGate0AdapterV1* out_adapter);

RS_TERMINAL_GATE0_API RsTerminalGate0Result
