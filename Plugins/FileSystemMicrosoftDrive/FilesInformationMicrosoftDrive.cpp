...
size_t FilesInformationMicrosoftDrive::AlignUp(size_t value, size_t alignment) noexcept
{
    const size_t mask = alignment - 1u;
    return (value + mask) & ~mask;
}

size_t FilesInformationMicrosoftDrive::ComputeEntrySizeBytes(std::wstring_view name) noexcept
{
...
HRESULT FilesInformationMicrosoftDrive::LocateEntry(unsigned long index, FileInfo** ppEntry) const noexcept
{
