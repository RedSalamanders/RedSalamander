...
[[nodiscard]] std::vector<DxUi::MenuFlyoutItem> ConvertHMenuToFlyoutItems(HMENU menu, const ShortcutManager* shortcutManager) noexcept
{
...
void FolderView::OnContextMenu(POINT screenPt, const bool keyboardInvocation)
{
    ...
    auto result        = DxUi::ContextMenu::Show(_hWnd.get(), screenPt, flyoutItems, palette);
