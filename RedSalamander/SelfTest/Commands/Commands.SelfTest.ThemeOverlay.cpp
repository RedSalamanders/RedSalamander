...
[[nodiscard]] bool TestThemeCycleOverlayRenderingGeometryAndRecovery(HWND mainWindow, CaseState& state) noexcept
{
    ...
    RedSalamander::DxUi::WindowHostBitmapCapture midCapture{};
    ...
    RedSalamander::DxUi::WindowHostBitmapCapture transitionCapture{};
    ...
    RedSalamander::DxUi::WindowHostBitmapCapture recoveredCapture{};
