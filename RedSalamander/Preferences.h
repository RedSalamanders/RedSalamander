...
struct PreferencesDebugSnapshot
{
    ...
    bool hotPathsContentRootVisible                                             = false;
    bool hotPathsContentRootEnabled                                             = false;
    size_t hotPathsKnownControlCount                                            = 0u;
    size_t hotPathsKnownFocusableCount                                          = 0u;
    bool hotPathsFirstPathFocusable                                             = false;
    bool hotPathsFirstBrowseFocusable                                           = false;
    bool hotPathsFirstLabelFocusable                                            = false;
    bool hotPathsFirstShowInMenuFocusable                                       = false;
    bool hotPathsSecondPathFocusable                                            = false;
    bool hotPathsOpenPrefsFocusable                                             = false;
    ...
    size_t compareDirectoriesVisibleSectionHeaderCount                          = 0u;
    ...
    bool categoryTreeDxHostFocusControlActive             = false;
    UINT_PTR nativeFocusWindow                            = 0u;
    int nativeFocusControlId                              = 0;
    std::wstring nativeFocusClassName;
    bool nativeFocusWithinPageHost             = false;
    UINT_PTR activeWindow                      = 0u;
    UINT_PTR foregroundWindow                  = 0u;
    uint32_t foregroundProcessId               = 0u;
    ...
    uint64_t categoryTreeDxHostInvalidateCount = 0u;
...
[[nodiscard]] bool DebugGetPreferencesCategoryClientRect(PrefCategory category, RECT& outRect) noexcept;
[[nodiscard]] bool DebugSelectPreferencesPluginsTreeChild(size_t childIndex) noexcept;
[[nodiscard]] bool DebugFocusPreferencesCategoryTree() noexcept;
[[nodiscard]] bool DebugSendPreferencesCategoryTreeKey(UINT virtualKey) noexcept;
...
[[nodiscard]] bool DebugGetPreferencesKeyboardVisibleRowPresentationByCommandId(std::wstring_view commandId,
...
[[nodiscard]] bool DebugParsePreferencesShortcutImport(std::string_view jsonText, Common::Settings::ShortcutsSettings& shortcuts, std::wstring& error) noexcept;
