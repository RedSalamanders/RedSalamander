...
[[nodiscard]] bool DebugGetConnectionManagerTextInputBridgeHandle(HWND& outBridge) noexcept;
...
[[nodiscard]] bool DebugGetTextInputBridgeHandle(HWND& outBridge) noexcept;
