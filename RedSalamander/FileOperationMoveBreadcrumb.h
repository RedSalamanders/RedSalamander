...
[[nodiscard]] std::optional<std::wstring> TryDecodeNavigationInstanceContext(std::wstring_view canonicalInstanceId);
...
public:
    ...
    [[nodiscard]] const Record& GetRecord() const noexcept
    {
        return _record;
    }
