...
template <typename... Rest> [[nodiscard]] constexpr uint8_t ScopeMask(CommandShortcutScope first, Rest... rest) noexcept
{
...
constexpr auto kCommands = std::to_array<CommandInfo>({
    ...
    DefineCommand(L"cmd/terminal/tab/select/1",
                  IDS_CMD_TERMINAL_TAB_SELECT_1,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab1,
                  L"select terminal tab one"),
    DefineCommand(L"cmd/terminal/tab/select/2",
                  IDS_CMD_TERMINAL_TAB_SELECT_2,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  ...
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab2,
                  L"select terminal tab two"),
    DefineCommand(L"cmd/terminal/tab/select/3",
                  IDS_CMD_TERMINAL_TAB_SELECT_3,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  ...
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab3,
                  L"select terminal tab three"),
    DefineCommand(L"cmd/terminal/tab/select/4",
                  IDS_CMD_TERMINAL_TAB_SELECT_4,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab4,
                  L"select terminal tab four"),
    DefineCommand(L"cmd/terminal/tab/select/5",
                  IDS_CMD_TERMINAL_TAB_SELECT_5,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab5,
                  L"select terminal tab five"),
    DefineCommand(L"cmd/terminal/tab/select/6",
                  IDS_CMD_TERMINAL_TAB_SELECT_6,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab6,
                  L"select terminal tab six"),
    DefineCommand(L"cmd/terminal/tab/select/7",
                  IDS_CMD_TERMINAL_TAB_SELECT_7,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab7,
                  L"select terminal tab seven"),
    DefineCommand(L"cmd/terminal/tab/select/8",
                  IDS_CMD_TERMINAL_TAB_SELECT_8,
                  IDS_CMD_DESC_TERMINAL_TAB_SELECT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Tab8,
                  L"select terminal tab eight"),
});
