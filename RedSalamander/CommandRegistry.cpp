...
[[nodiscard]] constexpr uint8_t ScopeMask(CommandShortcutScope first) noexcept
{
    return CommandShortcutScopeMask(first);
}

template<typename... Rest>
[[nodiscard]] constexpr uint8_t ScopeMask(CommandShortcutScope first, Rest... rest) noexcept
{
    return static_cast<uint8_t>(CommandShortcutScopeMask(first) | ScopeMask(rest...));
}

[[nodiscard]] constexpr CommandInfo DefineCommand(std::wstring_view id,
                                                   unsigned int displayNameStringId,
                                                   unsigned int descriptionStringId,
                                                   unsigned int wmCommandId,
                                                   CommandExecutorOwner executorOwner,
                                                   CommandDispatchPath dispatchPath,
                                                   CommandStateSource stateSource,
                                                   uint8_t shortcutScopeMask,
                                                   CommandVisualId visualId,
                                                   std::wstring_view searchKeywords,
                                                   bool paletteVisible = true) noexcept
{
...
constexpr auto kCommands = std::to_array<CommandInfo>({
    CommandInfo{L"cmd/app/about", IDS_CMD_ABOUT, IDS_CMD_DESC_ABOUT, IDM_ABOUT},
    DefineCommand(L"cmd/app/commandPalette",
                  IDS_CMD_COMMAND_PALETTE,
                  IDS_CMD_DESC_COMMAND_PALETTE,
                  IDM_APP_COMMAND_PALETTE,
                  CommandExecutorOwner::ApplicationHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Application),
                  CommandVisualId::CommandPalette,
                  L"command launcher search actions"),
    CommandInfo{L"cmd/app/compare", IDS_CMD_COMPARE, IDS_CMD_DESC_COMPARE, IDM_APP_COMPARE},
    DefineCommand(L"cmd/app/exit",
                  IDS_CMD_EXIT,
                  IDS_CMD_DESC_EXIT,
                  IDM_EXIT,
                  CommandExecutorOwner::ApplicationHost,
                  CommandDispatchPath::WmCommand,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::FunctionBar, CommandShortcutScope::FolderView, CommandShortcutScope::Terminal),
                  CommandVisualId::Close,
                  L"quit close application"),
    CommandInfo{L"cmd/app/externalHelp", IDS_CMD_EXTERNAL_HELP, IDS_CMD_DESC_EXTERNAL_HELP, IDM_APP_EXTERNAL_HELP},
    DefineCommand(L"cmd/app/fullScreen",
                  IDS_CMD_FULL_SCREEN,
                  IDS_CMD_DESC_FULL_SCREEN,
                  IDM_APP_FULL_SCREEN,
                  CommandExecutorOwner::ApplicationHost,
                  CommandDispatchPath::WmCommand,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::FunctionBar, CommandShortcutScope::FolderView, CommandShortcutScope::Terminal),
                  CommandVisualId::FullScreen,
                  L"fullscreen maximize screen"),
    ...
    DefineCommand(L"cmd/app/openSettingsFile",
                  IDS_CMD_OPEN_SETTINGS_FILE,
                  IDS_CMD_DESC_OPEN_SETTINGS_FILE,
                  0,
                  CommandExecutorOwner::ApplicationHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Application),
                  CommandVisualId::SettingsFile,
                  L"settings json configuration editor"),
    ...
    DefineCommand(L"cmd/app/preferences",
                  IDS_CMD_PREFERENCES,
                  IDS_CMD_DESC_PREFERENCES,
                  IDM_FILE_PREFERENCES,
                  CommandExecutorOwner::ApplicationHost,
                  CommandDispatchPath::WmCommand,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Application, CommandShortcutScope::FunctionBar, CommandShortcutScope::FolderView),
                  CommandVisualId::Settings,
                  L"settings preferences options"),
    ...
    DefineCommand(L"cmd/app/showFileOperations",
                  IDS_CMD_SHOW_FILE_OPERATIONS,
                  IDS_CMD_DESC_SHOW_FILE_OPERATIONS,
                  IDM_VIEW_FILE_OPERATIONS,
                  CommandExecutorOwner::ApplicationHost,
                  CommandDispatchPath::WmCommand,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Application),
                  CommandVisualId::Window,
                  L"file operations jobs transfers progress conflicts"),
    ...
    DefineCommand(L"cmd/app/systemMenu",
                  IDS_CMD_WINDOW_MENU,
                  IDS_CMD_DESC_WINDOW_MENU,
                  0,
                  CommandExecutorOwner::ApplicationHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Window,
                  L"window system menu move size minimize maximize"),
    ...
    CommandInfo{L"cmd/pane/bringFullPathToTerminal",
                IDS_CMD_BRING_FULL_PATH_TO_TERMINAL,
                IDS_CMD_DESC_BRING_FULL_PATH_TO_TERMINAL,
                IDM_PANE_BRING_FULL_PATH_TO_TERMINAL},
    ...
    DefineCommand(L"cmd/pane/connect",
                  IDS_CMD_CONNECT,
                  IDS_CMD_DESC_CONNECT,
                  IDM_PANE_CONNECT,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::WmCommand,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FunctionBar, CommandShortcutScope::FolderView),
                  CommandVisualId::Connect,
                  L"connect connection plugin"),
    CommandInfo{L"cmd/pane/connections", IDS_CMD_CONNECTIONS, IDS_CMD_DESC_CONNECTIONS, IDM_PANE_CONNECTION_MANAGER},
    DefineCommand(L"cmd/pane/contentTab/last",
                  IDS_CMD_CONTENT_TAB_LAST,
                  IDS_CMD_DESC_CONTENT_TAB_LAST,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FolderView),
                  CommandVisualId::LastTab,
                  L"last content tab"),
    DefineCommand(L"cmd/pane/contentTab/next",
                  IDS_CMD_CONTENT_TAB_NEXT,
                  IDS_CMD_DESC_CONTENT_TAB_NEXT,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FolderView),
                  CommandVisualId::NextTab,
                  L"next content tab"),
    DefineCommand(L"cmd/pane/contentTab/previous",
                  IDS_CMD_CONTENT_TAB_PREVIOUS,
                  IDS_CMD_DESC_CONTENT_TAB_PREVIOUS,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FolderView),
                  CommandVisualId::PreviousTab,
                  L"previous content tab"),
    DefineCommand(L"cmd/pane/contentTab/select/1",
                  IDS_CMD_CONTENT_TAB_FOLDER,
                  IDS_CMD_DESC_CONTENT_TAB_FOLDER,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FolderView),
                  CommandVisualId::Tab1,
                  L"folder content tab one"),
    DefineCommand(L"cmd/pane/contentTab/select/2",
                  IDS_CMD_CONTENT_TAB_PREVIEW,
                  IDS_CMD_DESC_CONTENT_TAB_PREVIEW,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FolderView),
                  CommandVisualId::Tab2,
                  L"preview content tab two"),
    DefineCommand(L"cmd/pane/contentTab/select/3",
                  IDS_CMD_CONTENT_TAB_TERMINAL,
                  IDS_CMD_DESC_CONTENT_TAB_TERMINAL,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FolderView),
                  CommandVisualId::Tab3,
                  L"terminal content tab three"),
    ...
    CommandInfo{L"cmd/pane/copyToOtherPaneWithOptions", IDS_CMD_COPY_WITH_OPTIONS, IDS_CMD_DESC_COPY_WITH_OPTIONS, IDM_PANE_COPY_TO_OTHER_WITH_OPTIONS},
    CommandInfo{L"cmd/pane/copyUncPathAndNameAsText", IDS_CMD_COPY_PATH_AND_FILE_NAME, IDS_CMD_DESC_COPY_PATH_AND_FILE_NAME, IDM_PANE_COPY_PATH_AND_FILE_NAME},
    ...
    DefineCommand(L"cmd/pane/focus/left",
                  IDS_CMD_PANE_FOCUS_LEFT,
                  IDS_CMD_DESC_PANE_FOCUS_LEFT,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::FocusLeft,
                  L"focus left pane panel"),
    DefineCommand(L"cmd/pane/focus/right",
                  IDS_CMD_PANE_FOCUS_RIGHT,
                  IDS_CMD_DESC_PANE_FOCUS_RIGHT,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::FocusRight,
                  L"focus right pane panel"),
    ...
    CommandInfo{L"cmd/pane/moveToOtherPaneWithOptions", IDS_CMD_MOVE_WITH_OPTIONS, IDS_CMD_DESC_MOVE_WITH_OPTIONS, IDM_PANE_MOVE_TO_OTHER_WITH_OPTIONS},
    ...
    DefineCommand(L"cmd/pane/resizeSplitter/left",
                  IDS_CMD_PANE_RESIZE_SPLITTER_LEFT,
                  IDS_CMD_DESC_PANE_RESIZE_SPLITTER_LEFT,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ResizeLeft,
                  L"resize divider splitter left"),
    DefineCommand(L"cmd/pane/resizeSplitter/right",
                  IDS_CMD_PANE_RESIZE_SPLITTER_RIGHT,
                  IDS_CMD_DESC_PANE_RESIZE_SPLITTER_RIGHT,
                  0,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ResizeRight,
                  L"resize divider splitter right"),
    ...
    DefineCommand(L"cmd/pane/switchPaneFocus",
                  IDS_CMD_SWITCH_PANE_FOCUS,
                  IDS_CMD_DESC_SWITCH_PANE_FOCUS,
                  IDM_VIEW_SWITCH_PANE_FOCUS,
                  CommandExecutorOwner::PaneHost,
                  CommandDispatchPath::WmCommand,
                  CommandStateSource::PaneHost,
                  ScopeMask(CommandShortcutScope::FunctionBar, CommandShortcutScope::FolderView, CommandShortcutScope::Terminal),
                  CommandVisualId::SwitchPane,
                  L"switch swap pane focus"),
    ...
    DefineCommand(L"cmd/terminal/close",
                  IDS_CMD_TERMINAL_CLOSE,
                  IDS_CMD_DESC_TERMINAL_CLOSE,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::CloseTab,
                  L"close terminal tab session"),
    DefineCommand(L"cmd/terminal/contextMenu",
                  IDS_CMD_CONTEXT_MENU,
                  IDS_CMD_DESC_CONTEXT_MENU,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ContextMenu,
                  L"terminal context menu more"),
    DefineCommand(L"cmd/terminal/copy",
                  IDS_CMD_CLIPBOARD_COPY,
                  IDS_CMD_DESC_CLIPBOARD_COPY,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Copy,
                  L"copy terminal selection clipboard"),
    DefineCommand(L"cmd/terminal/copySelectionOrPassthrough",
                  IDS_CMD_TERMINAL_COPY_SELECTION_OR_PASSTHROUGH,
                  IDS_CMD_DESC_TERMINAL_COPY_SELECTION_OR_PASSTHROUGH,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::CopyOrInput,
                  L"copy selection input enter interrupt passthrough"),
    DefineCommand(L"cmd/terminal/find",
                  IDS_CMD_TERMINAL_FIND,
                  IDS_CMD_DESC_TERMINAL_FIND,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Search,
                  L"find search terminal text output"),
    DefineCommand(L"cmd/terminal/font/decrease",
                  IDS_CMD_TERMINAL_FONT_DECREASE,
                  IDS_CMD_DESC_TERMINAL_FONT_DECREASE,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ZoomOut,
                  L"decrease terminal font text size zoom out"),
    DefineCommand(L"cmd/terminal/font/increase",
                  IDS_CMD_TERMINAL_FONT_INCREASE,
                  IDS_CMD_DESC_TERMINAL_FONT_INCREASE,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ZoomIn,
                  L"increase terminal font text size zoom in"),
    DefineCommand(L"cmd/terminal/font/reset",
                  IDS_CMD_TERMINAL_FONT_RESET,
                  IDS_CMD_DESC_TERMINAL_FONT_RESET,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ZoomReset,
                  L"reset terminal font text size zoom"),
    DefineCommand(L"cmd/terminal/openFloatingWindow",
                  IDS_CMD_TERMINAL_OPEN_FLOATING_WINDOW,
                  IDS_CMD_DESC_TERMINAL_OPEN_FLOATING_WINDOW,
                  IDM_TERMINAL_OPEN_FLOATING_WINDOW,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::FolderView, CommandShortcutScope::Terminal),
                  CommandVisualId::NewWindow,
                  L"open floating terminal window tab"),
    DefineCommand(L"cmd/terminal/paste",
                  IDS_CMD_CLIPBOARD_PASTE,
                  IDS_CMD_DESC_CLIPBOARD_PASTE,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::Paste,
                  L"paste clipboard terminal"),
    DefineCommand(L"cmd/terminal/scroll/bottom",
                  IDS_CMD_TERMINAL_SCROLL_BOTTOM,
                  IDS_CMD_DESC_TERMINAL_SCROLL_BOTTOM,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ScrollBottom,
                  L"scroll terminal bottom end"),
    DefineCommand(L"cmd/terminal/scroll/lineDown",
                  IDS_CMD_TERMINAL_SCROLL_LINE_DOWN,
                  IDS_CMD_DESC_TERMINAL_SCROLL_LINE_DOWN,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ScrollLineDown,
                  L"scroll terminal line down"),
    DefineCommand(L"cmd/terminal/scroll/lineUp",
                  IDS_CMD_TERMINAL_SCROLL_LINE_UP,
                  IDS_CMD_DESC_TERMINAL_SCROLL_LINE_UP,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ScrollLineUp,
                  L"scroll terminal line up"),
    DefineCommand(L"cmd/terminal/scroll/pageDown",
                  IDS_CMD_TERMINAL_SCROLL_PAGE_DOWN,
                  IDS_CMD_DESC_TERMINAL_SCROLL_PAGE_DOWN,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ScrollPageDown,
                  L"scroll terminal page down"),
    DefineCommand(L"cmd/terminal/scroll/pageUp",
                  IDS_CMD_TERMINAL_SCROLL_PAGE_UP,
                  IDS_CMD_DESC_TERMINAL_SCROLL_PAGE_UP,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ScrollPageUp,
                  L"scroll terminal page up"),
    DefineCommand(L"cmd/terminal/scroll/top",
                  IDS_CMD_TERMINAL_SCROLL_TOP,
                  IDS_CMD_DESC_TERMINAL_SCROLL_TOP,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::ScrollTop,
                  L"scroll terminal top home"),
    DefineCommand(L"cmd/terminal/selectAll",
                  IDS_CMD_SELECTION_SELECT_ALL,
                  IDS_CMD_DESC_SELECTION_SELECT_ALL,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::SelectAll,
                  L"select all terminal text"),
    DefineCommand(L"cmd/terminal/sessionMenu",
                  IDS_CMD_TERMINAL_SESSION_MENU,
                  IDS_CMD_DESC_TERMINAL_SESSION_MENU,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::TerminalMenu,
                  L"terminal session menu profile shell"),
    DefineCommand(L"cmd/terminal/suggestions",
                  IDS_CMD_TERMINAL_SUGGESTIONS,
                  IDS_CMD_DESC_TERMINAL_SUGGESTIONS,
                  0,
                  CommandExecutorOwner::TerminalPlugin,
                  CommandDispatchPath::TerminalActions,
                  CommandStateSource::TerminalActions,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::History,
                  L"command history suggestions search"),
    DefineCommand(L"cmd/terminal/tab/last",
                  IDS_CMD_TERMINAL_TAB_LAST,
                  IDS_CMD_DESC_TERMINAL_TAB_LAST,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::LastTab,
                  L"last terminal tab content"),
    DefineCommand(L"cmd/terminal/tab/new",
                  IDS_CMD_TERMINAL_TAB_NEW,
                  IDS_CMD_DESC_TERMINAL_TAB_NEW,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::NewTab,
                  L"new terminal tab other pane"),
    DefineCommand(L"cmd/terminal/tab/next",
                  IDS_CMD_TERMINAL_TAB_NEXT,
                  IDS_CMD_DESC_TERMINAL_TAB_NEXT,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::NextTab,
                  L"next terminal tab content"),
    DefineCommand(L"cmd/terminal/tab/previous",
                  IDS_CMD_TERMINAL_TAB_PREVIOUS,
                  IDS_CMD_DESC_TERMINAL_TAB_PREVIOUS,
                  0,
                  CommandExecutorOwner::TerminalHost,
                  CommandDispatchPath::StableCommandId,
                  CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal),
                  CommandVisualId::PreviousTab,
                  L"previous terminal tab content"),
    DefineCommand(L"cmd/terminal/tab/select/1", IDS_CMD_TERMINAL_TAB_SELECT_1, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab1, L"select terminal tab one"),
    DefineCommand(L"cmd/terminal/tab/select/2", IDS_CMD_TERMINAL_TAB_SELECT_2, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab2, L"select terminal tab two"),
    DefineCommand(L"cmd/terminal/tab/select/3", IDS_CMD_TERMINAL_TAB_SELECT_3, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab3, L"select terminal tab three"),
    DefineCommand(L"cmd/terminal/tab/select/4", IDS_CMD_TERMINAL_TAB_SELECT_4, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab4, L"select terminal tab four"),
    DefineCommand(L"cmd/terminal/tab/select/5", IDS_CMD_TERMINAL_TAB_SELECT_5, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab5, L"select terminal tab five"),
    DefineCommand(L"cmd/terminal/tab/select/6", IDS_CMD_TERMINAL_TAB_SELECT_6, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab6, L"select terminal tab six"),
    DefineCommand(L"cmd/terminal/tab/select/7", IDS_CMD_TERMINAL_TAB_SELECT_7, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab7, L"select terminal tab seven"),
    DefineCommand(L"cmd/terminal/tab/select/8", IDS_CMD_TERMINAL_TAB_SELECT_8, IDS_CMD_DESC_TERMINAL_TAB_SELECT, 0,
                  CommandExecutorOwner::TerminalHost, CommandDispatchPath::StableCommandId, CommandStateSource::ApplicationHost,
                  ScopeMask(CommandShortcutScope::Terminal), CommandVisualId::Tab8, L"select terminal tab eight"),
});
