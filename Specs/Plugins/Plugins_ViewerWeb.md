...
- The blocked Save As close assertion reports elapsed microseconds and the provider's emergency-timeout count so a slow close can be distinguished from a provider released by its timeout. The close deadline and provider timeout remain unchanged.
