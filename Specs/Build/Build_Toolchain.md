...
and on the ASan pull-request lane; `CI` on the nightly `nightly-ci.yml` matrix and the
weekly ASan lane; `Full` remains the local closeout gate). Cross-job nightly/package handoffs still require portable attestation.
