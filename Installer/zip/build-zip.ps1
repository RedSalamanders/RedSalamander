...
2. Winget's "RedSalamander" command alias runs RedLauncher.exe, which starts
   RedSalamander.exe from this directory so app-local DLLs are found
3. Run RedSalamanderMonitor.exe for debugging/monitoring
